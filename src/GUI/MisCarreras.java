...
public class MisCarreras extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jMenuBarMiCarrera = new javax.swing.JMenuBar();
        jMenuMiPerfil = new javax.swing.JMenu();
        jMenuMisCarreras = new javax.swing.JMenu();
        ...
        jMenuMiPerfil.setText("Mi perfil");
        jMenuBarMiCarrera.add(jMenuMiPerfil);

        jMenuMisCarreras.setText("Mis carreras");
        jMenuBarMiCarrera.add(jMenuMisCarreras);

        jMenuCarreras.setText("Carreras");
        jMenuBarMiCarrera.add(jMenuCarreras);

        jMenuCorredores.setText("Corredores");
        jMenuBarMiCarrera.add(jMenuCorredores);

        setJMenuBar(jMenuBarMiCarrera);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MisCarreras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MisCarreras().setVisible(true);
            }
        });
    }
